/**
 * You may alter or copy the contents of this file into your own interfaces file.
 * If you do not already have an interfaces file, please move all your interfaces 
 * into an src/interfaces.ts and copy the contents of this file into that new file
 */
...
// these are assuming previous examples - you can replace with your own
...
export interface Astronaut {
    ...
    timeAdded: number,
    timeLastEdited: number,
    // no need to have assignedMission as that is a generated values
};
...
export interface Launch {
    ...
    timeCreated: number; // time in seconds that this launch was created
